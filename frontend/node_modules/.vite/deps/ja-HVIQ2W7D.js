...
var languages = {
  ...
  chy: "シャイアン語",
  ckb: "中央クルド語",
  "ckb_alt-menu": "クルド語（中央）",
  "ckb_alt-variant": "クルド語（ソラニー）",
  clc: "チルコーティン語",
  cnr: "モンテネグロ語",
  co: "コルシカ語",
  cop: "コプト語",
...
var timezoneNames = {
  ...
  America: {
    ...
    Atikokan: "アティコカン",
    Bahia: "バイーア",
    Bahia_Banderas: "バイアバンデラ",
    Barbados: "バルバドス",
    Belem: "ベレン",
    Belize: "ベリーズ",
    "Blanc-Sablon": "ブラン・サブロン",
    Boa_Vista: "ボアビスタ",
    Bogota: "ボゴタ",
    Boise: "ボイシ",
    Cambridge_Bay: "ケンブリッジベイ",
    Campo_Grande: "カンポグランデ",
    Cancun: "カンクン",
    Caracas: "カラカス",
    Cayenne: "カイエンヌ",
    Cayman: "ケイマン",
    Chicago: "シカゴ",
    Chihuahua: "チワワ",
    Ciudad_Juarez: "シウダー・フアレス",
    Costa_Rica: "コスタリカ",
    Creston: "クレストン",
    Cuiaba: "クイアバ",
    Curacao: "キュラソー",
    Danmarkshavn: "デンマークシャウン",
    Dawson: "ドーソン",
    Dawson_Creek: "ドーソンクリーク",
    Denver: "デンバー",
    Detroit: "デトロイト",
    Dominica: "ドミニカ",
    Edmonton: "エドモントン",
    ...
    Indiana: {
      ...
      Knox: "インディアナ州ノックス",
      Marengo: "インディアナ州マレンゴ",
      Petersburg: "インディアナ州ピーターズバーグ",
      Tell_City: "インディアナ州テルシティ",
      Vevay: "インディアナ州ビベー",
      Vincennes: "インディアナ州ビンセンス",
      Winamac: "インディアナ州ウィナマック"
    },
    Inuvik: "イヌヴィク",
    Iqaluit: "イカルイット",
    Jamaica: "ジャマイカ",
    ...
    Kentucky: {
      Louisville: "ルイビル",
      Monticello: "ケンタッキー州モンティチェロ"
    },
    Kralendijk: "クラレンダイク",
    La_Paz: "ラパス",
    Lima: "リマ",
    Los_Angeles: "ロサンゼルス",
    Lower_Princes: "ローワー・プリンセズ・クウォーター",
    Maceio: "マセイオ",
    Managua: "マナグア",
    Manaus: "マナウス",
    Marigot: "マリゴ",
    ...
    Port_of_Spain: "ポートオブスペイン",
    Porto_Velho: "ポルトベーリョ",
    Puerto_Rico: "プエルトリコ",
    Punta_Arenas: "プンタアレナス",
    Rainy_River: "レイニーリバー",
    Rankin_Inlet: "ランキンインレット",
    Recife: "レシフェ",
    Regina: "レジャイナ",
    Resolute: "レゾリュート",
    Rio_Branco: "リオブランコ",
    Santa_Isabel: "サンタイサベル",
    Santarem: "サンタレム",
    Santiago: "サンチアゴ",
    Santo_Domingo: "サントドミンゴ",
    Sao_Paulo: "サンパウロ",
    Scoresbysund: "イトコルトルミット",
    Sitka: "シトカ",
    St_Barthelemy: "サン・バルテルミー",
    St_Johns: "セントジョンズ",
    St_Kitts: "セントクリストファー",
    St_Lucia: "セントルシア",
    St_Thomas: "セントトーマス",
    St_Vincent: "セントビンセント",
    Swift_Current: "スウィフトカレント",
    Tegucigalpa: "テグシガルパ",
    Thule: "チューレ",
    Thunder_Bay: "サンダーベイ",
    Tijuana: "ティフアナ",
...
//# sourceMappingURL=ja-HVIQ2W7D.js.map
