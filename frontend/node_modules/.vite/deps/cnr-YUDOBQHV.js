...
// node_modules/@ui5/webcomponents-localization/dist/generated/assets/cldr/cnr.json
...
var languages = {
  ...
  zh: "kineski",
  "zh_alt-menu": "mandarinski kineski",
...
var timezoneNames = {
  ...
  America: {
    ...
    Argentina: {
      Buenos_Aires: "Buenos Ajres",
      Catamarca: "Katamarka",
      Cordoba: "Kordoba",
      Jujuy: "Žužui",
      La_Rioja: "La Rioha",
      Mendoza: "Mendosa",
      Rio_Gallegos: "Rio Galjegos",
      Salta: "Salta",
      San_Juan: "San Huan",
      San_Luis: "San Lui",
      Tucuman: "Tukuman",
    ...
    Aruba: "Aruba",
    Asuncion: "Asunsion",
    Atikokan: "Koral Harbur",
    Bahia: "Baija",
    Bahia_Banderas: "Baija Banderas",
    Barbados: "Barbados",
    Belem: "Belem",
    Belize: "Belize",
    "Blanc-Sablon": "Blank-Sejblon",
    Boa_Vista: "Boa Vista",
    Bogota: "Bogota",
    Boise: "Bojzi",
    Cambridge_Bay: "Kembridž Bej",
    Campo_Grande: "Kampo Grande",
    Cancun: "Kankun",
    Caracas: "Karakas",
    Cayenne: "Kajen",
    ...
    Cuiaba: "Kuiaba",
    Curacao: "Kurasao",
    Danmarkshavn: "Danmarkshagen",
    Dawson: "Doson",
    Dawson_Creek: "Doson Krik",
    Denver: "Denver",
    Detroit: "Detroit",
    Dominica: "Dominika",
    Edmonton: "Edmonton",
    ...
    Halifax: "Halifaks",
    Havana: "Havana",
    Hermosillo: "Hermosiljo",
    Indiana: {
      Indianapolis: "Indianapolis",
      Knox: "Noks, Indijana",
      Marengo: "Marengo, Indijana",
      Petersburg: "Pitersburg, Indijana",
      Tell_City: "Tel Siti, Indijana",
      Vevay: "Vevaj, Indijana",
      Vincennes: "Vincenes, Indijana",
      Winamac: "Vinamak, Indijana"
    },
    Inuvik: "Inuvik",
    Iqaluit: "Ikvaluit",
    Jamaica: "Jamajka",
    ...
    Kentucky: {
      Louisville: "Luivile",
      Monticello: "Montičelo, Kentaki"
    },
    Kralendijk: "Kralendajk",
    La_Paz: "La Paz",
    Lima: "Lima",
    Los_Angeles: "Los Anđeles",
    Lower_Princes: "Louer Prinsiz Kvorter",
    Maceio: "Masejo",
    Managua: "Managva",
    Manaus: "Manaus",
    Marigot: "Marigo",
    ...
    Noronha: "Noronja",
    North_Dakota: {
      Beulah: "Bijula, Severna Dakota",
      Center: "Centar, Severna Dakota",
      New_Salem: "Novi Salem, Severna Dakota"
    },
    Nuuk: "Gothab",
    Ojinaga: "Ohinaga",
    Panama: "Panama",
    ...
    Port_of_Spain: "Port of Spejn",
    Porto_Velho: "Porto Veljo",
    Puerto_Rico: "Porto Riko",
    Punta_Arenas: "Punta Arenas",
    Rainy_River: "Rejni River",
    Rankin_Inlet: "Rankin Inlet",
    Recife: "Resife",
    Regina: "Regina",
    Resolute: "Resolut",
    Rio_Branco: "Rio Branko",
    Santa_Isabel: "Santa Izabel",
    Santarem: "Santarem",
    Santiago: "Santjago",
    Santo_Domingo: "Santo Domingo",
    Sao_Paulo: "Sao Paolo",
    Scoresbysund: "Skorezbisund",
    Sitka: "Sitka",
    St_Barthelemy: "Sv. Bartolomej",
    St_Johns: "Sv. Džon",
    St_Kitts: "Sent Kits",
    St_Lucia: "Sv. Lucija",
    St_Thomas: "Sv. Toma",
    St_Vincent: "Sent Vinsent",
    Swift_Current: "Svift Kurent",
    Tegucigalpa: "Tegusigalpa",
    Thule: "Tul",
    Thunder_Bay: "Tander Bej",
    Tijuana: "Tihuana",
    Toronto: "Toronto",
    Tortola: "Tortola",
    Vancouver: "Vankuver",
    ...
    Winnipeg: "Vinipeg",
    Yakutat: "Jakutat",
    Yellowknife: "Jelounajf",
    _parent: "Severna i Južna Amerika"
  },
  Antarctica: {
    Casey: "Kejsi",
    Davis: "Dejvis",
    DumontDUrville: "Dimon d’Urvil",
    Macquarie: "Mekvori",
    Mawson: "Moson",
    McMurdo: "Makmurdo",
    Palmer: "Palmer",
  ...
  Atlantic: {
    Azores: "Azori",
    Bermuda: "Bermuda",
    Canary: "Kanarska ostrva",
    Cape_Verde: "Zelenortska Ostrva",
    Faroe: "Farska Ostrva",
    Madeira: "Madeira",
    Reykjavik: "Rejkjavik",
    South_Georgia: "Južna Džordžija",
    St_Helena: "Sveta Jelena",
    Stanley: "Stenli"
  },
  Australia: {
    Adelaide: "Adelejd",
    Brisbane: "Brizbejn",
    Broken_Hill: "Broken Hil",
    Darwin: "Darvin",
    Eucla: "Iukla",
    Hobart: "Hobart",
    Lindeman: "Lindeman",
  ...
  Etc: {
    UTC: "UTC",
    Universal: "Koordinisano univerzalno vreme"
  },
  Europe: {
    Amsterdam: "Amsterdam",
    Andorra: "Andora",
  ...
  Pacific: {
    Apia: "Apija",
    Auckland: "Okland",
    Bougainville: "Buganvil",
    Chatham: "Čatam",
    Chuuk: "Truk",
    Easter: "Uskršnje ostrvo",
    Efate: "Efat",
    Fakaofo: "Fakaofo",
    Fiji: "Fidži",
    Funafuti: "Funafuti",
    Galapagos: "Galapagos",
    Gambier: "Gambije",
    Guadalcanal: "Gvadalkanal",
    Guam: "Guam",
    Honolulu: "Honolulu",
    Kanton: "Kanton",
    Kiritimati: "Kiritimati",
    Kosrae: "Košre",
    Kwajalein: "Kvadžalejin",
    Majuro: "Majuro",
    Marquesas: "Markiz",
    Midway: "Midvej",
    Nauru: "Nauru",
...
//# sourceMappingURL=cnr-YUDOBQHV.js.map
