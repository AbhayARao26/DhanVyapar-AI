...
var languages = {
  ...
  "ckb_alt-menu": "кюрдски (централен)",
  "ckb_alt-variant": "кюрдски (Сорани)",
  clc: "чилкотин",
  cnr: "черногорски",
  co: "корсикански",
  cop: "коптски",
  ...
  yrl: "ненгату",
  yue: "кантонски",
  "yue_alt-menu": "китайски, кантонски",
  za: "зуанг",
  zap: "запотек",
  zbl: "блис символи",
  zen: "зенага",
...
var timezoneNames = {
  ...
  America: {
    ...
    Belem: "Белем",
    Belize: "Белиз",
    "Blanc-Sablon": "Блан-Саблон",
    Boa_Vista: "Боа Виста",
    Bogota: "Богота",
    Boise: "Бойси",
    Cambridge_Bay: "Кеймбридж Бей",
    Campo_Grande: "Кампо Гранде",
    Cancun: "Канкун",
    Caracas: "Каракас",
    Cayenne: "Кайен",
    Cayman: "Кайманови острови",
    Chicago: "Чикаго",
    Chihuahua: "Чиуауа",
    Ciudad_Juarez: "Сиудад Хуарес",
    ...
    Fort_Nelson: "Форт Нелсън",
    Fortaleza: "Форталеза",
    Glace_Bay: "Глейс Бей",
    Goose_Bay: "Гус Бей",
    Grand_Turk: "Гранд Търк",
    Grenada: "Гренада",
    ...
    Halifax: "Халифакс",
    Havana: "Хавана",
    Hermosillo: "Ермосильо",
    Indiana: {
      Indianapolis: "Индианаполис",
      Knox: "Нокс",
      Marengo: "Маренго",
      Petersburg: "Питърсбърг",
      Tell_City: "Тел Сити",
      Vevay: "Виви",
      Vincennes: "Винсенс",
      Winamac: "Уинамак"
    ...
    La_Paz: "Ла Пас",
    Lima: "Лима",
    Los_Angeles: "Лос Анджелис",
    Lower_Princes: "Лоуър принсес куотър",
    Maceio: "Масейо",
    Managua: "Манагуа",
    Manaus: "Манаус",
    Marigot: "Мариго",
    ...
    Port_of_Spain: "Порт ъф Спейн",
    Porto_Velho: "Порто Вельо",
    Puerto_Rico: "Пуерто Рико",
    Punta_Arenas: "Пунта Аренас",
    Rainy_River: "Рейни Ривър",
    Rankin_Inlet: "Ранкин Инлет",
    Recife: "Ресифе",
    Regina: "Риджайна",
    Resolute: "Резолют",
    Rio_Branco: "Рио Бранко",
    Santa_Isabel: "Санта Исабел",
    Santarem: "Сантарем",
    Santiago: "Сантяго",
    Santo_Domingo: "Санто Доминго",
    Sao_Paulo: "Сао Пауло",
    Scoresbysund: "Сгорсбисон",
    Sitka: "Ситка",
    St_Barthelemy: "Сен Бартелеми",
    St_Johns: "Сейнт Джонс",
    St_Kitts: "Сейнт Китс",
    St_Lucia: "Сейнт Лусия",
    St_Thomas: "Сейнт Томас",
    St_Vincent: "Сейнт Винсънт",
    Swift_Current: "Суифт Кърент",
    Tegucigalpa: "Тегусигалпа",
    Thule: "Туле",
    Thunder_Bay: "Тъндър Бей",
    Tijuana: "Тихуана",
    Toronto: "Торонто",
    Tortola: "Тортола",
    Vancouver: "Ванкувър",
    ...
    Winnipeg: "Уинипег",
    Yakutat: "Якутат",
    Yellowknife: "Йелоунайф",
    _parent: "Америка"
  },
  Antarctica: {
    Casey: "Кейси",
    Davis: "Дейвис",
    DumontDUrville: "Дюмон Дюрвил",
    Macquarie: "Маккуори",
    Mawson: "Моусън",
    McMurdo: "Макмърдо",
    Palmer: "Палмър",
  ...
  Atlantic: {
    ...
    Faroe: "Фарьорски острови",
    Madeira: "Мадейра",
    Reykjavik: "Рейкявик",
    South_Georgia: "Южна Джорджия",
  ...
  Etc: {
    UTC: "UTC",
    Universal: "Координирано универсално време"
  },
  Europe: {
    Amsterdam: "Амстердам",
    Andorra: "Андора",
  ...
  Pacific: {
    Apia: "Апия",
    Auckland: "Окланд",
    Bougainville: "Бугенвил",
    Chatham: "Чатам",
    Chuuk: "Чуюк",
    Easter: "Великденски остров",
    Efate: "Ефате",
    Fakaofo: "Факаофо",
    Fiji: "Фиджи",
    Funafuti: "Фунафути",
...
//# sourceMappingURL=bg-6XBKPFXR.js.map
