...
var timezoneNames = {
  ...
  America: {
    ...
    Araguaina: "أروجوانيا",
    Argentina: {
      Buenos_Aires: "بوينوس أيرس",
      Catamarca: "كاتاماركا",
      Cordoba: "كوردوبا",
      Jujuy: "جوجو",
      La_Rioja: "لا ريوجا",
      Mendoza: "ميندوزا",
      Rio_Gallegos: "ريو جالييوس",
      Salta: "سالطا",
      San_Juan: "سان خوان",
      San_Luis: "سان لويس",
      Tucuman: "تاكمان",
    ...
    Bogota: "بوغوتا",
    Boise: "بويس",
    Cambridge_Bay: "كامبرديج باي",
    Campo_Grande: "كومبو جراند",
    Cancun: "كانكون",
    Caracas: "كاراكاس",
    Cayenne: "كايين",
    Cayman: "كايمان",
    ...
    Cuiaba: "كيابا",
    Curacao: "كوراساو",
    Danmarkshavn: "دانمرك شافن",
    Dawson: "داوسان",
    Dawson_Creek: "داوسن كريك",
    Denver: "دنفر",
    Detroit: "ديترويت",
    Dominica: "دومينيكا",
    Edmonton: "ايدمونتون",
    ...
    Kentucky: {
      Louisville: "لويس فيل",
      Monticello: "مونتيسيلو"
    },
    Kralendijk: "كرالنديك",
    La_Paz: "لا باز",
    Lima: "ليما",
    Los_Angeles: "لوس انجلوس",
    Lower_Princes: "حي الأمير السفلي",
    Maceio: "ماشيو",
    Managua: "ماناغوا",
    Manaus: "ماناوس",
    Marigot: "ماريغوت",
  ...
  Antarctica: {
    Casey: "كاساي",
    Davis: "دافيز",
    DumontDUrville: "دي مونت دو روفيل",
    Macquarie: "ماكواري",
    Mawson: "ماوسون",
    McMurdo: "ماك موردو",
    Palmer: "بالمير",
  ...
  Asia: {
    ...
    Famagusta: "فاماغوستا",
    Gaza: "غزة",
    Hebron: "هيبرون (مدينة الخليل)",
    Ho_Chi_Minh: "مدينة هو تشي منة",
    Hong_Kong: "هونغ كونغ",
    Hovd: "هوفد",
    Irkutsk: "ايركيتسك",
    Jakarta: "جاكرتا",
    ...
    Muscat: "مسقط",
    Nicosia: "نيقوسيا",
    Novokuznetsk: "نوفوكوزنتسك",
    Novosibirsk: "نوفوسبيرسك",
    Omsk: "أومسك",
    Oral: "أورال",
    Phnom_Penh: "بنوم بنه",
    Pontianak: "بونتيانك",
    ...
    Tokyo: "طوكيو",
    Tomsk: "تومسك",
    Ulaanbaatar: "آلانباتار",
    Urumqi: "أرومكي",
    "Ust-Nera": "أوست نيرا",
    Vientiane: "فيانتيان",
    Vladivostok: "فلاديفوستك",
    Yakutsk: "ياكتسك",
    Yangon: "رانغون",
    Yekaterinburg: "يكاترنبيرج",
    Yerevan: "يريفان",
    _parent: "آسيا"
  },
  Atlantic: {
  ...
  Etc: {
    UTC: "UTC",
    Universal: "التوقيت العالمي المنسق"
  },
  Europe: {
    Amsterdam: "أمستردام",
    Andorra: "أندورا",
...
var units = {
  short: {
    ...
    "duration-quarter": {
      displayName: "ربع سنوي",
      "unitPattern-count-zero": "{0} ربع",
      "unitPattern-count-one": "ربع",
      "unitPattern-count-two": "ربعان",
      "unitPattern-count-few": "{0} أرباع",
      "unitPattern-count-many": "{0} ربعًا",
      "unitPattern-count-other": "{0} ربع",
      perUnitPattern: "{0}/ربع سنوي"
    },
    "duration-month": {
      displayName: "شهور",
...
//# sourceMappingURL=ar_SA-H6ILN2EG.js.map
