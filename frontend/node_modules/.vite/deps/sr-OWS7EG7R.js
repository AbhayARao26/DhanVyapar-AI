...
var languages = {
  ...
  "ckb_alt-menu": "централни курдски",
  "ckb_alt-variant": "централни курдски",
  clc: "чилкотин",
  cnr: "црногорски",
  co: "корзикански",
  cop: "коптски",
...
var timezoneNames = {
  ...
  America: {
    ...
    Argentina: {
      Buenos_Aires: "Буенос Ајрес",
      Catamarca: "Катамарка",
      Cordoba: "Кордоба",
      Jujuy: "Жужуи",
      La_Rioja: "Ла Риоха",
      Mendoza: "Мендоса",
      Rio_Gallegos: "Рио Гаљегос",
      Salta: "Салта",
      San_Juan: "Сан Хуан",
      San_Luis: "Сан Луи",
      Tucuman: "Тукуман",
    ...
    Aruba: "Аруба",
    Asuncion: "Асунсион",
    Atikokan: "Корал Харбур",
    Bahia: "Баија",
    Bahia_Banderas: "Баија Бандерас",
    Barbados: "Барбадос",
    Belem: "Белем",
    Belize: "Белизе",
    ...
    Indiana: {
      ...
      Vevay: "Вевај, Индијана",
      Vincennes: "Винценес, Индијана",
    ...
    La_Paz: "Ла Паз",
    Lima: "Лима",
    Los_Angeles: "Лос Анђелес",
    Lower_Princes: "Лоуер Принсиз Квортер",
    Maceio: "Масејо",
    Managua: "Манагва",
    Manaus: "Манаус",
    Marigot: "Мариго",
    ...
    Noronha: "Нороња",
    North_Dakota: {
      Beulah: "Бијула, Северна Дакота",
      Center: "Центар, Северна Дакота",
      New_Salem: "Нови Салем, Северна Дакота"
    },
    Nuuk: "Готхаб",
    Ojinaga: "Охинага",
    Panama: "Панама",
    ...
    Santa_Isabel: "Санта Изабел",
    Santarem: "Сантарем",
    Santiago: "Сантјаго",
    Santo_Domingo: "Санто Доминго",
    Sao_Paulo: "Сао Паоло",
    Scoresbysund: "Скорезбисунд",
    Sitka: "Ситка",
    St_Barthelemy: "Св. Бартоломeј",
    St_Johns: "Св. Џон",
    St_Kitts: "Сент Китс",
    St_Lucia: "Св. Луција",
    St_Thomas: "Св. Тома",
    ...
    _parent: "Северна и Јужна Америка"
  },
  Antarctica: {
    Casey: "Кејси",
    Davis: "Дејвис",
    DumontDUrville: "Димон д’Урвил",
    Macquarie: "Меквори",
    Mawson: "Мосон",
    McMurdo: "Макмурдо",
    Palmer: "Палмер",
  ...
  Asia: {
    ...
    Urumqi: "Урумћи",
    "Ust-Nera": "Уст-Нера",
    Vientiane: "Вијентијан",
    Vladivostok: "Владивосток",
    Yakutsk: "Јакутск",
    Yangon: "Рангун",
    Yekaterinburg: "Јекатеринбург",
    Yerevan: "Јереван",
    _parent: "Азија"
  },
  Atlantic: {
    Azores: "Азори",
    Bermuda: "Бермуда",
    Canary: "Канарска острва",
    Cape_Verde: "Зеленортска Острва",
    Faroe: "Фарска Острва",
    Madeira: "Мадеира",
    Reykjavik: "Рејкјавик",
    South_Georgia: "Јужна Џорџија",
    St_Helena: "Света Јелена",
    Stanley: "Стенли"
  },
  Australia: {
    Adelaide: "Аделејд",
  ...
  Etc: {
    UTC: "UTC",
    Universal: "Координисано универзално време"
  },
  Europe: {
    Amsterdam: "Амстердам",
    Andorra: "Андора",
    ...
    Guernsey: "Гернзи",
    Helsinki: "Хелсинки",
    Isle_of_Man: "Острво Ман",
    Istanbul: "Истанбул",
    Jersey: "Џерзи",
    Kaliningrad: "Калињинград",
    Kiev: "Кијев",
    Kirov: "Киров",
    Lisbon: "Лисабон",
    Ljubljana: "Љубљана",
...
//# sourceMappingURL=sr-OWS7EG7R.js.map
