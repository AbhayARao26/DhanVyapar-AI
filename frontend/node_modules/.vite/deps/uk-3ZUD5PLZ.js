...
var languages = {
  ...
  "ars_alt-menu": "арабська, надждійська",
  arw: "аравакська",
  as: "асамська",
  asa: "асу",
  ...
  zh: "китайська",
  "zh_alt-menu": "китайська мандаринська",
...
var timezoneNames = {
  ...
  America: {
    ...
    Bogota: "Боґота",
    Boise: "Бойсе",
    Cambridge_Bay: "Кеймбрідж-Бей",
    Campo_Grande: "Кампу-Ґранді",
    Cancun: "Канкун",
    Caracas: "Каракас",
    Cayenne: "Каєнна",
    ...
    Cuiaba: "Куяба",
    Curacao: "Кюрасао",
    Danmarkshavn: "Денмарксхавн",
    Dawson: "Доусон",
    Dawson_Creek: "Доусон-Крік",
    Denver: "Денвер",
    Detroit: "Детройт",
    Dominica: "Домініка",
    Edmonton: "Едмонтон",
    ...
    Halifax: "Галіфакс",
    Havana: "Гавана",
    Hermosillo: "Ермосільйо",
    Indiana: {
      Indianapolis: "Індіанаполіс",
      Knox: "Нокс, Індіана",
      Marengo: "Маренго, Індіана",
      Petersburg: "Пітерсберг, Індіана",
      Tell_City: "Телл-Сіті, Індіана",
      Vevay: "Вівей, Індіана",
      Vincennes: "Вінсенс, Індіана",
      Winamac: "Вінамак, Індіана"
    },
    Inuvik: "Інувік",
    Iqaluit: "Ікалуїт",
    Jamaica: "Ямайка",
    ...
    Kentucky: {
      Louisville: "Луїсвілл",
      Monticello: "Монтіселло, Кентуккі"
    },
    Kralendijk: "Кралендейк",
    La_Paz: "Ла-Пас",
    Lima: "Ліма",
    Los_Angeles: "Лос-Анджелес",
    Lower_Princes: "Лоуер-Принсес-Квотер",
    Maceio: "Масейо",
    Managua: "Манаґуа",
    Manaus: "Манаус",
    Marigot: "Маріґо",
    ...
    Noronha: "Норонья",
    North_Dakota: {
      Beulah: "Бʼюла, Північна Дакота",
      Center: "Сентр, Північна Дакота",
      New_Salem: "Нью-Салем, Північна Дакота"
    },
    Nuuk: "Нуук",
    Ojinaga: "Охінаґа",
    Panama: "Панама",
    Pangnirtung: "Панґніртанґ",
    ...
    Rainy_River: "Рейні-Рівер",
    Rankin_Inlet: "Ренкін-Інлет",
    Recife: "Ресіфі",
    Regina: "Реджайна",
    Resolute: "Резольют",
    Rio_Branco: "Ріо-Бранко",
    Santa_Isabel: "Санта-Ісабель",
    Santarem: "Сантарен",
    Santiago: "Сантьяґо",
    Santo_Domingo: "Санто-Домінґо",
    Sao_Paulo: "Сан-Паулу",
    Scoresbysund: "Іттоккортоорміут",
    Sitka: "Сітка",
    St_Barthelemy: "Сен-Бартелемі",
    St_Johns: "Сент-Джонс",
    St_Kitts: "Сент-Кіттс",
    St_Lucia: "Сент-Люсія",
    St_Thomas: "Сент-Томас",
    St_Vincent: "Сент-Вінсент",
    Swift_Current: "Свіфт-Каррент",
    Tegucigalpa: "Теґусіґальпа",
    Thule: "Туле",
    ...
    Winnipeg: "Вінніпеґ",
    Yakutat: "Якутат",
    Yellowknife: "Єллоунайф",
    _parent: "Американський регіон"
  },
  Antarctica: {
    Casey: "Кейсі",
    Davis: "Девіс",
    DumontDUrville: "Дюмон-дʼЮрвіль",
    Macquarie: "Маккуорі",
    Mawson: "Моусон",
    McMurdo: "Мак-Мердо",
    Palmer: "Палмер",
  ...
  Asia: {
    ...
    Shanghai: "Шанхай",
    Singapore: "Сінгапур",
    Srednekolymsk: "Середньоколимськ",
    Taipei: "Тайбей",
    Tashkent: "Ташкент",
    Tbilisi: "Тбілісі",
    Tehran: "Тегеран",
  ...
  Atlantic: {
    ...
    St_Helena: "Острів Святої Єлени",
    Stanley: "Стенлі"
  },
  Australia: {
    Adelaide: "Аделаїда",
    Brisbane: "Брісбен",
    Broken_Hill: "Брокен-Хілл",
    Darwin: "Дарвін",
    Eucla: "Евкла",
    Hobart: "Гобарт",
    Lindeman: "Ліндеман",
  ...
  Etc: {
    UTC: "UTC",
    Universal: "за всесвітнім координованим часом"
  },
  Europe: {
    Amsterdam: "Амстердам",
    Andorra: "Андорра",
...
//# sourceMappingURL=uk-3ZUD5PLZ.js.map
