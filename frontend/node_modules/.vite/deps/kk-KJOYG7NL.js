...
var languages = {
  ...
  chy: "шайен тілі",
  ckb: "сорани тілі",
  "ckb_alt-menu": "сорани тілі",
  "ckb_alt-variant": "сорани тілі",
  clc: "чилкотин тілі",
  cnr: "Черногор",
  co: "корсика тілі",
  crg: "мичиф тілі",
  ...
  yrl: "ньенгату тілі",
  yue: "кантон тілі",
  "yue_alt-menu": "қытай тілі (кантон)",
  zgh: "марокколық стандартты тамазигхт тілі",
  zh: "қытай тілі",
  "zh_alt-menu": "қытай тілі (мандарин)",
...
var timezoneNames = {
  ...
  America: {
    ...
    Atikokan: "Атикокан",
    Bahia: "Баия",
    Bahia_Banderas: "Баия-де-Бандерас",
    Barbados: "Барбадос",
    Belem: "Белен",
    Belize: "Белиз",
    ...
    Bogota: "Богота",
    Boise: "Бойсе",
    Cambridge_Bay: "Кембридж-Бей",
    Campo_Grande: "Кампу-Гранди",
    Cancun: "Канкун",
    Caracas: "Каракас",
    Cayenne: "Кайенна",
    Cayman: "Кайман аралдары",
    Chicago: "Чикаго",
    Chihuahua: "Чиуауа",
    Ciudad_Juarez: "Сьюдад-Хуарес",
    Costa_Rica: "Коста-Рика",
    Creston: "Крестон",
    Cuiaba: "Куяба",
    Curacao: "Кюрасао",
    Danmarkshavn: "Данмарксхавн",
    Dawson: "Доусон",
    ...
    Fort_Nelson: "Форт-Нельсон",
    Fortaleza: "Форталеза",
    Glace_Bay: "Глейс-Бей",
    Goose_Bay: "Гус-Бей",
    Grand_Turk: "Гранд-Терк",
    Grenada: "Гренада",
    ...
    Indiana: {
      ...
      Knox: "Нокс, Индиана",
      Marengo: "Маренго, Индиана",
      Petersburg: "Питерсберг, Индиана",
      Tell_City: "Телл-Сити, Индиана",
      Vevay: "Вивей, Индиана",
      Vincennes: "Винсеннес, Индиана",
      Winamac: "Уинамак, Индиана"
    },
    Inuvik: "Инувик",
    Iqaluit: "Икалуит",
    Jamaica: "Ямайка",
    ...
    Kentucky: {
      Louisville: "Луисвилл",
      Monticello: "Монтиселло, Кентукки"
    },
    Kralendijk: "Кралендейк",
    La_Paz: "Ла-Пас",
    Lima: "Лима",
    Los_Angeles: "Лос-Анджелес",
    Lower_Princes: "Лоуэр-Принс-Куотер",
    Maceio: "Масейо",
    Managua: "Манагуа",
    Manaus: "Манаус",
    Marigot: "Мариго",
    ...
    Noronha: "Норонья",
    North_Dakota: {
      Beulah: "Бойла, Солтүстік Дакота",
      Center: "Сентер, Солтүстік Дакота",
      New_Salem: "Нью Сейлем, Солтүстік Дакота"
    },
    Nuuk: "Нуук",
    Ojinaga: "Охинага",
    Panama: "Панама",
    Pangnirtung: "Пангниртанг",
    Paramaribo: "Парамарибо",
    Phoenix: "Финикс",
    "Port-au-Prince": "Порт-о-Пренс",
    Port_of_Spain: "Порт-оф-Спейн",
    Porto_Velho: "Порту-Велью",
    Puerto_Rico: "Пуэрто-Рико",
    Punta_Arenas: "Пунта-Аренас",
    Rainy_River: "Рейни-Ривер",
    Rankin_Inlet: "Ранкин-Инлет",
    Recife: "Ресифи",
    Regina: "Реджайна",
    Resolute: "Резольют",
    Rio_Branco: "Риу-Бранку",
    Santa_Isabel: "Санта-Исабель",
    Santarem: "Сантарен",
    Santiago: "Сантьяго",
    Santo_Domingo: "Санто-Доминго",
    Sao_Paulo: "Сан-Паулу",
    Scoresbysund: "Иллоккортоормиут",
    Sitka: "Ситка",
    St_Barthelemy: "Сен-Бартелеми",
    St_Johns: "Сент-Джонс",
    St_Kitts: "Сент-Китс",
    St_Lucia: "Сент-Люсия",
    St_Thomas: "Сент-Томас",
    St_Vincent: "Сент-Винсент",
    Swift_Current: "Суифт-Каррент",
    Tegucigalpa: "Тегусигальпа",
    Thule: "Туле",
    Thunder_Bay: "Тандер-Бей",
    Tijuana: "Тихуана",
    Toronto: "Торонто",
    Tortola: "Тортола",
    Vancouver: "Ванкувер",
  ...
  Atlantic: {
    Azores: "Азор аралдары",
    Bermuda: "Бермуд аралдары",
    Canary: "Канар аралдары",
    Cape_Verde: "Кабо-Верде",
    Faroe: "Фарер аралдары",
    Madeira: "Мадейра",
    Reykjavik: "Рейкьявик",
    South_Georgia: "Оңтүстік Георгия",
    St_Helena: "Әулие Елена аралы",
    Stanley: "Стэнли"
  },
  Australia: {
    Adelaide: "Аделаида",
    Brisbane: "Брисбен",
    Broken_Hill: "Брокен-Хилл",
    Darwin: "Дарвин",
    Eucla: "Юкла",
    Hobart: "Хобарт",
    Lindeman: "Линдеман",
  ...
  Etc: {
    UTC: "UTC",
    Universal: "Дүниежүзілік үйлестірілген уақыт"
  },
  Europe: {
    Amsterdam: "Амстердам",
    Andorra: "Андорра",
  ...
  Indian: {
    ...
    Chagos: "Чагос",
    Christmas: "Рождество аралы",
    Cocos: "Кокос аралдары",
    Comoro: "Комор аралдары",
    Kerguelen: "Кергелен",
    Mahe: "Маэ",
...
var units = {
  short: {
    ...
    "angle-degree": {
      ...
      "unitPattern-count-other": "{0} градус"
    },
    "angle-arc-minute": {
      displayName: "аркмин",
    ...
    "duration-quarter": {
      displayName: "тоқсан",
      "unitPattern-count-one": "{0} тоқсан",
      "unitPattern-count-other": "{0} тоқсан",
      perUnitPattern: "{0}/тоқсан"
    },
    "duration-month": {
      displayName: "ай",
    ...
    "graphics-pixel": {
      displayName: "пиксель",
      "unitPattern-count-one": "{0} пиксель",
      "unitPattern-count-other": "{0} пиксель"
    },
    "graphics-megapixel": {
      displayName: "мегапиксель",
    ...
    "graphics-pixel-per-inch": {
      displayName: "пиксель/дюйм",
      "unitPattern-count-one": "{0} пиксель/дюйм",
      "unitPattern-count-other": "{0} пиксель/дюйм"
    },
    ...
    "length-fathom": {
      displayName: "фатом",
      "unitPattern-count-one": "{0} фатом",
      "unitPattern-count-other": "{0} фатом"
    },
    ...
    "volume-cup-metric": {
      displayName: "мк",
      "unitPattern-count-one": "{0} мк",
      "unitPattern-count-other": "{0} мк"
    },
    "volume-acre-foot": {
      displayName: "акр-фут",
      "unitPattern-count-one": "{0} aкр-фут",
      "unitPattern-count-other": "{0} aкр-фут"
    },
    "volume-bushel": {
      displayName: "бушель",
      "unitPattern-count-one": "{0} бш",
      "unitPattern-count-other": "{0} бш"
    },
    "volume-gallon": {
      displayName: "гал.",
    ...
    "volume-gallon-imperial": {
      ...
      "unitPattern-count-one": "{0} брит. галлон",
      "unitPattern-count-other": "{0} брит. галлон",
    ...
    "volume-fluid-ounce-imperial": {
      displayName: "брит. сұй. унция",
      "unitPattern-count-one": "{0} брит. сұй. унция",
      "unitPattern-count-other": "{0} брит. сұй. унция"
    },
    "volume-tablespoon": {
      displayName: "ас қ.",
    ...
    "volume-barrel": {
      displayName: "баррель",
      "unitPattern-count-one": "{0} баррель",
      "unitPattern-count-other": "{0} баррель"
    },
...
//# sourceMappingURL=kk-KJOYG7NL.js.map
