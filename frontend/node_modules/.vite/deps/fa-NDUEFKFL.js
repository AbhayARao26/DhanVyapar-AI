...
var timezoneNames = {
  ...
  America: {
    ...
    Araguaina: "آراگواینا",
    Argentina: {
      Buenos_Aires: "بوئنوس‌آیرس",
      Catamarca: "کاتامارکا",
      Cordoba: "کوردووا",
      Jujuy: "خوخوی",
      La_Rioja: "لاریوخا",
      Mendoza: "مندوسا",
      Rio_Gallegos: "ریوگالگوس",
      Salta: "سالتا",
      San_Juan: "سن‌خوان",
      San_Luis: "سن‌لوئیس",
      Tucuman: "توکومن",
    ...
    Atikokan: "اتکوکان",
    Bahia: "بایا",
    Bahia_Banderas: "باهیا باندراس",
    Barbados: "باربادوس",
    Belem: "بلم",
    Belize: "بلیز",
    "Blanc-Sablon": "بلان‐سابلون",
    Boa_Vista: "بوئاویستا",
    Bogota: "بوگوتا",
    Boise: "بویسی",
    Cambridge_Bay: "کمبریج‌بی",
    Campo_Grande: "کمپو گرانده",
    Cancun: "کانکون",
    Caracas: "کاراکاس",
    Cayenne: "کاین",
    Cayman: "کیمن",
    ...
    Fort_Nelson: "فورت نلسون",
    Fortaleza: "فورتالزا",
    Glace_Bay: "گلیس‌بی",
    Goose_Bay: "گوس‌بی",
    Grand_Turk: "گراند تورک",
    Grenada: "گرنادا",
    Guadeloupe: "گوادلوپ",
    Guatemala: "گواتمالا",
    Guayaquil: "گوایاکیل",
    ...
    Indiana: {
      ...
      Knox: "ناکس، ایندیانا",
      Marengo: "مارنگو، ایندیانا",
      Petersburg: "پیترزبرگ، ایندیانا",
      Tell_City: "تل‌سیتی، ایندیانا",
      Vevay: "ویوی، ایندیانا",
      Vincennes: "وینسنس، اندیانا",
      Winamac: "ویناماک، ایندیانا"
    },
    Inuvik: "اینوویک",
    Iqaluit: "ایکلوئت",
    Jamaica: "جامائیکا",
    ...
    Kentucky: {
      Louisville: "لوئیزویل",
      Monticello: "مانتیسلو، کنتاکی"
    },
    Kralendijk: "کرالندیک",
    La_Paz: "لاپاز",
    Lima: "لیما",
    Los_Angeles: "لوس‌آنجلس",
    Lower_Princes: "بخش شاهزاده‌‌نشین پایین",
    Maceio: "ماسیو",
    Managua: "ماناگوا",
    Manaus: "ماناوس",
    Marigot: "ماریگات",
    ...
    Noronha: "نورونیا",
    North_Dakota: {
      Beulah: "بیولا، داکوتای شمالی",
      Center: "سنتر، داکوتای شمالی",
      New_Salem: "نیوسالم، داکوتای شمالی"
    },
    Nuuk: "نووک",
    Ojinaga: "اخیناگا",
    Panama: "پاناما",
    Pangnirtung: "پانگنیرتونگ",
    Paramaribo: "پاراماریبو",
    Phoenix: "فینکس",
    "Port-au-Prince": "پورتوپرنس",
    Port_of_Spain: "پورت‌آواسپین",
    Porto_Velho: "پورتوولیو",
    Puerto_Rico: "پورتوریکو",
    Punta_Arenas: "پونتا آرناس",
    Rainy_River: "رینی‌ریور",
    Rankin_Inlet: "خلیجک رنکین",
    Recife: "ریسیفی",
    Regina: "رجاینا",
    Resolute: "رزولوت",
    Rio_Branco: "ریوبرانکو",
    Santa_Isabel: "سانتا ایزابل",
    Santarem: "سنتارم",
    Santiago: "سانتیاگو",
    Santo_Domingo: "سانتو دومینگو",
    Sao_Paulo: "سائوپائولو",
    Scoresbysund: "اسکورسبیسوند",
    Sitka: "سیتکا",
    St_Barthelemy: "سنت بارتلمی",
    St_Johns: "سنت جان",
    St_Kitts: "سنت کیتس",
    St_Lucia: "سنت لوسیا",
    St_Thomas: "سنت توماس",
    St_Vincent: "سنت وینسنت",
    Swift_Current: "سویفت‌کارنت",
...
var units = {
  short: {
    ...
    "duration-quarter": {
      displayName: "سه‌ماه",
      "unitPattern-count-one": "{0} سه‌ماهه",
      "unitPattern-count-other": "{0} سه‌ماهه",
      perUnitPattern: "{0}/سه‌ماه"
    },
    "duration-month": {
      displayName: "ماه",
...
//# sourceMappingURL=fa-NDUEFKFL.js.map
