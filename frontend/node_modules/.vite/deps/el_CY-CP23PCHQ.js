...
var languages = {
  ...
  "ckb_alt-menu": "Κουρδικά, Κεντρικά",
  "ckb_alt-variant": "Κουρδικά, Σοράνι",
  clc: "Τσιλκότιν",
  cnr: "Μαυροβουνιακά",
  co: "Κορσικανικά",
  cop: "Κοπτικά",
  ...
  yrl: "Νινγκατού",
  yue: "Καντονέζικα",
  "yue_alt-menu": "Κινεζικά, Καντονέζικα",
  za: "Ζουάνγκ",
  zap: "Ζάποτεκ",
  zbl: "Σύμβολα Bliss",
  zen: "Ζενάγκα",
  ...
  zh: "Κινεζικά",
  "zh_alt-menu": "Κινεζικά, Μανδαρινικά",
...
var timezoneNames = {
  Africa: {
    ...
    Kinshasa: "Κινσάσα",
    Lagos: "Λάγκος",
    Libreville: "Λιμπρεβίλ",
    Lome: "Λομέ",
    Luanda: "Λουάντα",
    Lubumbashi: "Λουμπουμπάσι",
    Lusaka: "Λουζάκα",
    Malabo: "Μαλάμπο",
    Maputo: "Μαπούτο",
    Maseru: "Μασέρου",
  ...
  America: {
    ...
    Anguilla: "Ανγκουίλα",
    Antigua: "Αντίγκουα",
    Araguaina: "Αραγκουάινα",
    Argentina: {
      Buenos_Aires: "Μπουένος Άιρες",
      Catamarca: "Καταμάρκα",
      Cordoba: "Κόρδοβα",
      Jujuy: "Χουχούι",
      La_Rioja: "Λα Ριόχα",
      Mendoza: "Μεντόζα",
      Rio_Gallegos: "Ρίο Γκαγιέγκος",
      Salta: "Σάλτα",
      San_Juan: "Σαν Χουάν",
      San_Luis: "Σαν Λούις",
      Tucuman: "Τουκουμάν",
    ...
    Atikokan: "Ατικόκαν",
    Bahia: "Μπαΐα",
    Bahia_Banderas: "Μπαΐα ντε Μπαντέρας",
    Barbados: "Μπαρμπέιντος",
    Belem: "Μπελέμ",
    Belize: "Μπελίζ",
    "Blanc-Sablon": "Μπλαν Σαμπλόν",
    Boa_Vista: "Μπόα Βίστα",
    Bogota: "Μπογκοτά",
    Boise: "Μπόιζι",
    Cambridge_Bay: "Κέμπριτζ Μπέι",
    Campo_Grande: "Κάμπο Γκράντε",
    Cancun: "Κανκούν",
    Caracas: "Καράκας",
    Cayenne: "Καγιέν",
    Cayman: "Κέιμαν",
    Chicago: "Σικάγο",
    Chihuahua: "Τσιουάουα",
    Ciudad_Juarez: "Σιουδάδ Χουάρες",
    Costa_Rica: "Κόστα Ρίκα",
    Creston: "Κρέστον",
    Cuiaba: "Κουιαμπά",
    Curacao: "Κουρασάο",
    Danmarkshavn: "Ντανμαρκσάβν",
    Dawson: "Ντόσον",
    Dawson_Creek: "Ντόσον Κρικ",
    Denver: "Ντένβερ",
    Detroit: "Ντιτρόιτ",
    Dominica: "Ντομίνικα",
    Edmonton: "Έντμοντον",
    ...
    Fort_Nelson: "Φορτ Νέλσον",
    Fortaleza: "Φορταλέζα",
    Glace_Bay: "Γκλέις Μπέι",
    Goose_Bay: "Γκους Μπέι",
    Grand_Turk: "Γκραντ Τουρκ",
    Grenada: "Γρενάδα",
    ...
    Halifax: "Χάλιφαξ",
    Havana: "Αβάνα",
    Hermosillo: "Ερμοσίγιο",
    Indiana: {
      Indianapolis: "Ιντιανάπολις",
      Knox: "Νοξ, Ιντιάνα",
      Marengo: "Μαρένγκο, Ιντιάνα",
      Petersburg: "Πίτερσμπεργκ, Ιντιάνα",
      Tell_City: "Τελ Σίτι, Ιντιάνα",
      Vevay: "Βιβέι, Ιντιάνα",
      Vincennes: "Βανσέν, Ιντιάνα",
      Winamac: "Γουίναμακ, Ιντιάνα"
    },
    Inuvik: "Ινούβικ",
    Iqaluit: "Ικαλούιτ",
    Jamaica: "Τζαμάικα",
    ...
    Kentucky: {
      Louisville: "Λούιβιλ",
      Monticello: "Μοντιτσέλο, Κεντάκι"
    },
    Kralendijk: "Κράλεντικ",
    La_Paz: "Λα Παζ",
    Lima: "Λίμα",
    Los_Angeles: "Λος Άντζελες",
    ...
    Menominee: "Μενομίνε",
    Merida: "Μέριδα",
    Metlakatla: "Μετλακάτλα",
    Mexico_City: "Πόλη του Μεξικού",
    Miquelon: "Μικελόν",
    Moncton: "Μόνκτον",
    Monterrey: "Μοντερέι",
    ...
    Noronha: "Νορόνια",
    North_Dakota: {
      Beulah: "Μπέουλα, Βόρεια Ντακότα",
      Center: "Σέντερ, Βόρεια Ντακότα",
      New_Salem: "Νιου Σέιλεμ, Βόρεια Ντακότα"
    },
    Nuuk: "Νουούκ",
    Ojinaga: "Οχινάγκα",
    Panama: "Παναμάς",
    Pangnirtung: "Πανγκνίρτουνγκ",
    Paramaribo: "Παραμαρίμπο",
    Phoenix: "Φοίνιξ",
    "Port-au-Prince": "Πορτ-ο-Πρενς",
    Port_of_Spain: "Πορτ οφ Σπέιν",
    Porto_Velho: "Πόρτο Βέλιο",
    Puerto_Rico: "Πουέρτο Ρίκο",
    Punta_Arenas: "Πούντα Αρένας",
    Rainy_River: "Ρέινι Ρίβερ",
    Rankin_Inlet: "Ράνκιν Ίνλετ",
    Recife: "Ρεσίφε",
    Regina: "Ρετζάινα",
    Resolute: "Ρέζολουτ",
    Rio_Branco: "Ρίο Μπράνκο",
    Santa_Isabel: "Σάντα Ιζαμπέλ",
    Santarem: "Σανταρέμ",
    Santiago: "Σαντιάγκο",
    Santo_Domingo: "Άγιος Δομίνικος",
    Sao_Paulo: "Σάο Πάολο",
    Scoresbysund: "Σκορεσμπίσουντ",
    Sitka: "Σίτκα",
    St_Barthelemy: "Άγιος Βαρθολομαίος",
    St_Johns: "Σεν Τζονς",
    St_Kitts: "Σεν Κιτς",
    St_Lucia: "Αγία Λουκία",
    St_Thomas: "Άγιος Θωμάς",
    St_Vincent: "Άγιος Βικέντιος",
    Swift_Current: "Σουίφτ Κάρεντ",
    Tegucigalpa: "Τεγκουσιγκάλπα",
    Thule: "Θούλη",
    Thunder_Bay: "Θάντερ Μπέι",
    Tijuana: "Τιχουάνα",
    Toronto: "Τορόντο",
    Tortola: "Τορτόλα",
    Vancouver: "Βανκούβερ",
    Whitehorse: "Γουάιτχορς",
    Winnipeg: "Γουίνιπεγκ",
    Yakutat: "Γιάκουτατ",
  ...
  Antarctica: {
    Casey: "Κάσεϊ",
    Davis: "Ντέιβις",
    DumontDUrville: "Ντιμόν ντ’ Ουρβίλ",
    Macquarie: "Μακουάρι",
    Mawson: "Μόσον",
    McMurdo: "Μακμέρντο",
    Palmer: "Πάλμερ",
  ...
  Asia: {
    ...
    Gaza: "Γάζα",
    Hebron: "Χεβρώνα",
    Ho_Chi_Minh: "Πόλη Χο Τσι Μινχ",
    Hong_Kong: "Χονγκ Κονγκ",
    Hovd: "Χοβντ",
    Irkutsk: "Ιρκούτσκ",
    Jakarta: "Τζακάρτα",
    Jayapura: "Τζαγιαπούρα",
    ...
    Khandyga: "Χαντίγκα",
    Kolkata: "Καλκούτα",
    Krasnoyarsk: "Κρασνογιάρσκ",
    Kuala_Lumpur: "Κουάλα Λουμπούρ",
    Kuching: "Κουτσίνγκ",
    Kuwait: "Κουβέιτ",
    Macau: "Μακάο",
    Magadan: "Μαγκαντάν",
    ...
    Muscat: "Μασκάτ",
    Nicosia: "Λευκωσία",
    Novokuznetsk: "Νοβοκουζνέτσκ",
    Novosibirsk: "Νοβοσιμπίρσκ",
    Omsk: "Ομσκ",
    Oral: "Οράλ",
    Phnom_Penh: "Πνομ Πενχ",
    Pontianak: "Πόντιανακ",
    Pyongyang: "Πιονγκγιάνγκ",
    Qatar: "Κατάρ",
    Qostanay: "Κοστανάι",
    Qyzylorda: "Κιζιλορντά",
    Riyadh: "Ριάντ",
    Sakhalin: "Σαχαλίνη",
  ...
  Atlantic: {
    ...
    Bermuda: "Βερμούδες",
    Canary: "Κανάρια",
    Cape_Verde: "Πράσινο Ακρωτήριο",
    Faroe: "Φερόες",
    Madeira: "Μαδέρα",
    Reykjavik: "Ρέυκιαβικ",
    South_Georgia: "Νότια Γεωργία",
    St_Helena: "Αγ. Ελένη",
    Stanley: "Στάνλεϊ"
  },
  Australia: {
    Adelaide: "Αδελαΐδα",
    Brisbane: "Μπρισμπέιν",
    Broken_Hill: "Μπρόκεν Χιλ",
    Darwin: "Ντάργουιν",
    Eucla: "Γιούκλα",
    Hobart: "Χόμπαρτ",
    Lindeman: "Λίντεμαν",
    Lord_Howe: "Λορντ Χάου",
    Melbourne: "Μελβούρνη",
    Perth: "Περθ",
    Sydney: "Σίδνεϊ",
    _parent: "Αυστραλία"
  ...
  Etc: {
    UTC: "UTC",
    Universal: "Συντονισμένη Παγκόσμια Ώρα"
  },
  Europe: {
    ...
    Guernsey: "Γκέρνζι",
    Helsinki: "Ελσίνκι",
    Isle_of_Man: "Νήσος του Μαν",
    Istanbul: "Κωνσταντινούπολη",
    Jersey: "Τζέρσεϊ",
    Kaliningrad: "Καλίνινγκραντ",
    Kiev: "Κίεβο",
    Kirov: "Κίροφ",
    Lisbon: "Λισαβόνα",
    ...
    Tallinn: "Ταλίν",
    Tirane: "Τίρανα",
    Ulyanovsk: "Ουλιάνοφσκ",
    Uzhgorod: "Ούζχοροντ",
    Vaduz: "Βαντούζ",
    Vatican: "Βατικανό",
    Vienna: "Βιέννη",
    Vilnius: "Βίλνιους",
    Volgograd: "Βόλγκοκραντ",
    Warsaw: "Βαρσοβία",
    Zagreb: "Ζάγκρεμπ",
    Zaporozhye: "Ζαπορόζιε",
    Zurich: "Ζυρίχη",
    _parent: "Ευρώπη"
  },
  Indian: {
  ...
  Pacific: {
    ...
    Fiji: "Φίτζι",
    Funafuti: "Φουναφούτι",
    Galapagos: "Γκαλάπαγκος",
    Gambier: "Γκάμπιερ",
    Guadalcanal: "Γκουανταλκανάλ",
    Guam: "Γκουάμ",
    Honolulu: "Χονολουλού",
    Kanton: "Καντών",
    Kiritimati: "Κιριτιμάτι",
    Kosrae: "Κόσραϊ",
    ...
    Norfolk: "Νόρφολκ",
    Noumea: "Νουμέα",
    Pago_Pago: "Πάγκο Πάγκο",
    Palau: "Παλάου",
    Pitcairn: "Πίτκερν",
    Pohnpei: "Πονάπε",
    Port_Moresby: "Πορτ Μόρεσμπι",
    Rarotonga: "Ραροτόνγκα",
    Saipan: "Σαϊπάν",
    Tahiti: "Ταϊτή",
    Tarawa: "Ταράουα",
    Tongatapu: "Τονγκατάπου",
    Wake: "Γουέικ",
    Wallis: "Γουάλις"
  }
};
...
var units = {
  short: {
    ...
    "duration-quarter": {
      displayName: "τετ.",
      "unitPattern-count-one": "{0} τέτ.",
      "unitPattern-count-other": "{0} τέτ/α",
      perUnitPattern: "{0}/τέτ."
    },
    "duration-month": {
      displayName: "μήνες",
...
//# sourceMappingURL=el_CY-CP23PCHQ.js.map
